...
export function WeatherAnalysisPage({ field, onBack }: WeatherAnalysisPageProps) {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-center h-64">
          <div className="animate-spin h-8 w-8 border-2 border-ag-green border-t-transparent rounded-full"></div>
        </div>
      </div>
    );
  }
